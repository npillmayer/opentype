...
func newGSUBApplicable(table tables.GSUBLookup) applicable {
	return applicable{objApply: func(c *otApplyContext) bool { return c.applyGSUB(table) }}
}

func newGPOSApplicable(table tables.GPOSLookup) applicable {
	return applicable{objApply: func(c *otApplyContext) bool { return c.applyGPOS(table) }}
}

func (ap applicable) apply(c *otApplyContext) bool {
	return ap.objApply(c)
}
